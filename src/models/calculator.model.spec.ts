...
describe('CalculatorModel', (): void => {
  ...
  it('should display `5` when the `2` key is pressed followed by the `+` key followed by the `3` key, followed by the `=` key', (): void => {
    ...
    expect(displayValue).toEqual('2 + 3 === 5');
  
  });

  it('should display `4` when the `2` key is pressed followed by the `+` key followed by the `3` key, followed by the `-` key, followed by the `1` key, followed by the `=` key', (): void => {
    ...
    expect(displayValue).toEqual('2 + 3 - 1 === 4');
  
  });

  it('should display `14` when the `2` key is pressed followed by the `+` key followed by the `3` key, followed by the `*` key, followed by the `4` key, followed by the `=` key', (): void => {
